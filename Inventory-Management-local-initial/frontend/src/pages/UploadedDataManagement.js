              ...
              <SummaryCard color1="#4facfe" color2="#00f2fe">
                <Card.Body>
                  <div className="summary-value">
                    {formatCurrency(
                      summary?.profitSummary?.deliveredProfit || 
                      calculateAllUploadTotals()?.deliveredAmount || 0
                    )}
                  </div>
                  <div className="summary-label">✅ Delivered Amount</div>
                </Card.Body>
              </SummaryCard>
            </Col>
            <Col md={3}>
              <SummaryCard color1="#fa709a" color2="#fee140">
                <Card.Body>
                  <div className="summary-value">
                    {formatCurrency(
                      summary?.profitSummary?.rpuProfit || 
                      calculateAllUploadTotals()?.rpuAmount || 0
                    )}
                  </div>
                  <div className="summary-label">🔄 RPU Amount</div>
                </Card.Body>
              </SummaryCard>
            </Col>
            <Col md={3}>
              <SummaryCard color1="#ffa500" color2="#ff6347">
                <Card.Body>
                  <div className="summary-value">
                    {formatCurrency(
                      summary?.profitSummary?.rtoProfit || 
                      calculateAllUploadTotals()?.rtoAmount || 0
                    )}
                  </div>
                  <div className="summary-label">📦 RTO Amount</div>
                </Card.Body>
              </SummaryCard>
            </Col>
            <Col md={3}>
          ...
          <tbody>
            {filteredUploads.map(upload => (
              <tr key={upload._id}>
                ...
                <td style={{ color: '#28a745', fontWeight: '600' }}>{formatCurrency(upload?.profitSummary?.deliveredProfit)}</td>
                <td style={{ color: '#dc3545', fontWeight: '600' }}>{formatCurrency(upload?.profitSummary?.rpuProfit || 0)}</td>
                <td style={{ color: '#ff6347', fontWeight: '600' }}>{formatCurrency(upload?.profitSummary?.rtoProfit || 0)}</td>
                <td>
